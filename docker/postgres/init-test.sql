-- =============================================================================
-- Neoboard PostgreSQL Init Script (E2E tests)
-- Runs on first container startup via /docker-entrypoint-initdb.d/
--
-- NOTE: The neoboard app schema is created by Drizzle migrations, which
-- global-setup.ts runs programmatically AFTER the container starts.
-- This file only creates the secondary "movies" database used by PG queries.
-- =============================================================================
