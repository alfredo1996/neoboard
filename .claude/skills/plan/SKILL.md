...
Read relevant source files and notes in `~/Desktop/neoboard-vault` to understand the current state.
...
Save the plan to `~/Desktop/neoboard-vault/roadmap/` using the Write tool. Do NOT modify any other files.
