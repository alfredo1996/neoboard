...
`SKILL.md` in this directory holds the rules. This file is the full system behind them: every token table, the chart palettes, dialog and grid sizes, and the critique format. `design-reviewer` reads both.
