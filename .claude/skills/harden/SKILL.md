...
- **Query scheduler saturation**: per-connector query scheduler hits `QUERY_MAX_QUEUE_DEPTH` under load — load-shedding/backpressure feedback (503) rather than a hang?
