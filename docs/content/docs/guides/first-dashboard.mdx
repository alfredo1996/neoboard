...
2. In the widget editor dialog, select a **connection** from the dropdown. This tells NeoBoard which database to query. If you have not added a connection yet, see the [Connecting to Your Database](/docs/guides/connecting-databases) guide first.
...
- Learn about different chart types in [Building Chart Widgets](/docs/guides/building-widgets).
- Set up database connections in [Connecting to Your Database](/docs/guides/connecting-databases).
- Control who can see your dashboards in [Managing Users and Permissions](/docs/guides/managing-users).
