...
- Use your new connection to [create your first dashboard](/docs/guides/first-dashboard).
- Learn about chart types in [Building Chart Widgets](/docs/guides/building-widgets).
