...
Open `http://localhost:3000` and log in with the demo accounts it prints — [Tour with demo data](/start-here/tour) shows what got seeded.

## Next Steps

<CardGrid>
  <LinkCard title="Tour with demo data" href="/start-here/tour" />
