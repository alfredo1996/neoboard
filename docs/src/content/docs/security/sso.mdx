...
<Aside type="note">
SSO is an enterprise feature. Set `NEOBOARD_EDITION=enterprise` in your environment to enable it. The enterprise edition is still in development: see [Enterprise edition](/start-here/enterprise).
</Aside>
