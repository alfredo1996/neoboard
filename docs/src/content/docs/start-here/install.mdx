...
Both options above set up a **development** stack. For a real deployment — pinned image, secrets, first admin, TLS — follow [Production deployment](/deploy/production).
