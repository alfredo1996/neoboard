...
Which of these are promoted into the offered set — and why the rest stay hidden — is decided per chart in the repository's [chart promotion table](https://github.com/alfredo1996/neoboard/blob/dev/component/CHARTS.md): render time at 1k and 10k rows, a light and dark review, and whether the chart's honesty work is done.
...
- **Hierarchical drill-down?** Use a [Sunburst](/charts/sunburst).
- **Project timelines?** Use a [Gantt](/charts/gantt) chart.

## Hidden from the picker

[Radar](/charts/radar) and [Choropleth](/charts/choropleth) are not offered when you add a widget or change its type. Widgets of those types, from an older dashboard or a NeoDash import, keep rendering and can still be edited.
