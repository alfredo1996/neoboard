...
Radar is not offered when you add a widget or change a widget's type. Radar widgets you already have, including ones from a NeoDash import, keep rendering.
:::
