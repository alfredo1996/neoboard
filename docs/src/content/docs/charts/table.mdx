...
| Column Filters | boolean | false | Show per-column filter inputs below each header |
...
- Turn on Column Filters for power users who need to drill into specific column values.
