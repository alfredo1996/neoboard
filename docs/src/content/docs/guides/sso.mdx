...
| `OIDC_ADMIN_VALUE` | No | — | Claim value that maps to Admin role |
| `OIDC_CREATOR_VALUE` | No | — | Claim value that maps to Creator role |
| `OIDC_READER_VALUE` | No | — | Claim value that maps to Reader role |
