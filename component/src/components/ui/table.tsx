...
>(({ className, ...props }, ref) => (
  <tr
    ref={ref}
    className={cn(
      "border-b transition-[color,background-color] [transition-duration:var(--duration-fast)] [transition-timing-function:var(--ease-standard)] hover:bg-muted/50 data-[state=selected]:bg-muted",
      className,
    )}
    {...props}
  />
