...
export function GraphChart({
  ...
  if (!nodes.length) {
    return (
      <div
        className={`flex h-full w-full items-center justify-center bg-muted/20 rounded ${className ?? ""}`}
      >
          ...
          <>
            ...
            <Popover>
              ...
              >
                ...
                {Array.from(labelPropertyMap.entries()).map(
                  ([lbl, propKeys]) => (
