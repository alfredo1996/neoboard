...
export type { StylingRule, StylingConfig, StylingOperator, CellFormatStyle, CellFormatRule, ColorScaleConfig, ConditionalFormatConfig } from "./styling-rule";
export { resolveStylingRuleColor, resolveCellFormat, interpolateColor } from "./styling-rule";
